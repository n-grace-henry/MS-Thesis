...
data.1 <- SL.1 <- read.csv("cleaned/20231122_GHenry_CSIA.csv") #modify with name of your data file
colnames(data.1)<-name
file.name <- "with_outliers/20231122.csv" #file name for output file including relative file path
