...
data.1 <- SL.1 <- read.csv("code/cleaned/20231115_GHenry_CSIA.csv") #modify with name of your data file
colnames(data.1)<-name
file.name <- "code/processed/20231115_corrected.csv" #file name for output file including relative file path
